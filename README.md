...
A full-stack book review platform with a modern React frontend and a Node.js/Express + PostgreSQL backend.
...
- **Backend:**  
  ...
  - Prisma for PostgreSQL access and schema validation
